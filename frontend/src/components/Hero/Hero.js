        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-left">
              <p className="text-xl sm:text-2xl lg:text-3xl font-semibold mb-4" style={{color: '#f8bd0a', fontFamily: 'Poppins, sans-serif', letterSpacing: '0.1em'}}>
                ELITE FILING
              </p>
              ...
              <p className="text-white text-xs sm:text-sm lg:text-base font-light mb-8 leading-relaxed max-w-2xl" style={{fontFamily: 'Inter, sans-serif', opacity: '0.9'}}>
