...
>
  <span className="mr-2">▶</span> Home
              ...
              <li>
                <Link to="/business-solutions/logo-creation" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 flex items-center"
              ...
              <li>
                <Link to="/USA/LLC-Formation" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 flex items-center"
                onClick={() => window.scrollTo(0, 0)}
                >
              ...
              <li>
                <Link to="/ecommerce/amazon" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 flex items-center"
                onClick={() => window.scrollTo(0, 0)}
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <div className="flex space-x-4">
                <a href="https://www.facebook.com/share/15ZiEbePKV/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center hover:bg-blue-700 transition-colors duration-300">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a
  href="https://x.com/Elite_Filing"
  target="_blank"
  rel="noopener noreferrer"
  className="w-10 h-10 bg-transparent rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors duration-300"
>
  <img 
  ...
  />
                ...
                <a
                  href="https://www.instagram.com/elitefiling/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-transparent rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors duration-300"
                >
                  <img 
                    src="https://www.freepnglogos.com/uploads/instagram-icon-png/instagram-application-logo-icon-png-19.png" 
                    alt="X Logo" 
                    className="w-10 h-10"
                  />
                </a>
                
                <a href="https://www.linkedin.com/company/elite-filing/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-800 transition-colors duration-300">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
