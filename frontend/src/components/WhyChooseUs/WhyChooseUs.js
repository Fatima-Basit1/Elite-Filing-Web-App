    ...
    <section className="py-3 px-2 relative overflow-hidden" style={{
      ...
      <div className="max-w-7xl mx-auto relative z-10">
       ...
       <div className="text-center mb-12">
          ...
          <div className="w-20 h-1 mx-auto rounded-full" style={{
            background: 'linear-gradient(90deg, #f8bd0a, #041e72)'
          }}></div>
        </div>

        {/* Content Arrangement: Features flanking the Video */}
        <div className="flex flex-col lg:flex-row items-stretch justify-center gap-6 mb-6">
          ...
          <div className="grid grid-cols-1 gap-6 w-full lg:w-1/3 xl:w-1/3">
            {features.slice(0, 2).map((feature, index) => (
              <div
                key={index}
                className="group relative p-6 rounded-2xl transition-all duration-500 hover:scale-105 hover:shadow-2xl cursor-pointer overflow-hidden h-full"
                style={{
